#include "SavvyPCH.h"
#include "SavvyConstructorHLSLToGLSLNoLoc.h"
...
Savvy::Internal::ConstructorHLSLToGLSLNoLoc::ConstructorHLSLToGLSLNoLoc() : ConstructorHLSLToGLSL()
{

}

Savvy::Internal::ConstructorHLSLToGLSLNoLoc::~ConstructorHLSLToGLSLNoLoc()
{

}

void Savvy::Internal::ConstructorHLSLToGLSLNoLoc::Reset()
{
	ConstructorHLSLToGLSL::Reset();
}

Savvy::ResultCode Savvy::Internal::ConstructorHLSLToGLSLNoLoc::Initialize(Key& a_InputEntry, Key& a_OutputEntry, uint32 a_Inputlang, uint32 a_ShaderType, Database* a_Database)
{
	return ConstructorHLSLToGLSL::Initialize(a_InputEntry, a_OutputEntry, a_Inputlang, a_ShaderType, a_Database);
}

Savvy::ResultCode Savvy::Internal::ConstructorHLSLToGLSLNoLoc::Construct(std::ostream& a_OutputStream)
{
	return ConstructorHLSLToGLSL::Construct(a_OutputStream);
}

Savvy::ResultCode Savvy::Internal::ConstructorHLSLToGLSLNoLoc::ConstructInputsGLSL(std::ostream& a_OutputStream)
{
...
Savvy::ResultCode Savvy::Internal::ConstructorHLSLToGLSLNoLoc::ConstructOutputsGLSL(std::ostream& a_OutputStream)
{
...
Savvy::ResultCode Savvy::Internal::ConstructorHLSLToGLSLNoLoc::ConstructUniformBuffersGLSL(std::ostream& a_OutputStream)
{
...
Savvy::ResultCode Savvy::Internal::ConstructorHLSLToGLSLNoLoc::ConstructSamplersGLSL(std::ostream& a_OutputStream)
{
...
Savvy::ResultCode Savvy::Internal::ConstructorHLSLToGLSLNoLoc::ConstructGenericBuffersGLSL(std::ostream& a_OutputStream)
{
